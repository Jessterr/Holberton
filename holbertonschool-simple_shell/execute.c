...
/**
* _execute - A function that _executes a command.
* @command: The pointer to _tokenized command.
* @name: The name of the shell.
* @env: The pointer to the env var.
* @cicles: Number of _executed cicles.
* Return: Nothing.
*/

void _execute(char **command, char *name, char **env, int cicles)
{
...
/**
* print_env - A function that prints all env var.
* @env: The pointer to env var.
* Return: Nothing.
*/
...
* env var PATH.
* @env: The pointer to env var.
* Return: All _tokenized pathways for commands.
*/
